...
const hi: LocaleStrings = {
  ...
  home: {
    ...
    sectionToday: 'आज',
    thisWeek: 'इस सप्ताह',
    progressDone: '{{total}} में से {{done}} पूरे',
    progressAllDone: 'सब पूरा — बहुत खूब',
    progressNoneDue: 'आज कुछ नहीं है',
    tip: {
      badge: 'सुझाव',
      start: 'बस एक से शुरू करें — छोटी जीतें स्ट्रीक बनाती हैं।',
      progress: 'बढ़िया गति! आज की सूची पर काम करते रहें।',
      allDone: 'आज हर आदत पूरी। आपका भविष्य आपका शुक्रिया कहता है!',
    },
    statusTodo: 'बाकी',
    statusDone: 'पूरा',
    stats: {
      bestStreak: 'सर्वोच्च स्ट्रीक',
      tracked: 'ट्रैक की गई',
      doneToday: 'आज पूरे',
      days: '{{count}} दिन',
    },
  ...
  settings: {
    ...
    timeFormatHint: 'चुनें कि रिमाइंडर समय कैसे दिखें और दर्ज हों।',
    language: 'भाषा',
  ...
  onboarding: {
    ...
    heroTitleTop: 'बेहतर',
    heroTitleEmph: 'आदतें बनाएँ',
    heroTitleBottom: 'Streaks के साथ',
    heroBubble: 'साथ में ज़्यादा मज़ा!',
    s1Title: 'लय बनाएँ',
  ...
  a11y: {
    ...
    hintUndoDone: 'इस आदत को आज के लिए अपूर्ण चिह्नित करता है।',
