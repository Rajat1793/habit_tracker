...
const en = {
  ...
  home: {
    ...
    progressAllDone: 'All caught up — great work',
    progressNoneDue: 'Nothing due today',
    tip: {
      badge: 'Tip',
      start: 'Start with just one — small wins build the streak.',
      progress: 'Nice momentum! Keep chipping away at today’s list.',
      allDone: 'Every habit done today. Your future self says thanks!',
    },
    statusTodo: 'To do',
    statusDone: 'Done',
    stats: {
    ...
    empty: {
      ...
      noHabitsCta: 'Create first habit',
  ...
  onboarding: {
    ...
    heroTitleTop: 'Go for',
    heroTitleEmph: 'better habits',
    heroTitleBottom: 'with Streaks',
    heroBubble: "It's more fun together!",
